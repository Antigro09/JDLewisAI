...
import { runTakeoffAction, type TakeoffState } from "./actions";

export function MaterialTakeoffClient() {
  const [state, action] = useActionState<TakeoffState, FormData>(
    runTakeoffAction,
    {},
  );
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <Card className="p-5">
          <form action={action} className="space-y-3">
            ...
            <SubmitButton pendingText="Reading invoices…">Generate takeoff</SubmitButton>
            {state.error && (
