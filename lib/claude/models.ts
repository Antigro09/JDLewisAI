...
export const MODELS: ModelInfo[] = [
  {
    id: "claude-opus-4-8",
    label: "Opus 4.8",
    blurb: "Most capable — best for hard reasoning, agentic & long tasks.",
    efforts: ALL_EFFORTS,
  ...
  },
  {
    ...
    label: "Sonnet 4.6",
    blurb: "Best balance of speed and intelligence for everyday work.",
    efforts: ALL_EFFORTS,
    adaptiveThinking: true,
    priceIn: 3,
    priceOut: 15,
  ...
  },
  {
    id: "claude-haiku-4-5",
    label: "Haiku 4.5",
    blurb: "Fastest and most economical for simple, quick tasks.",
